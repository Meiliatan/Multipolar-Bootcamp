...
public class TodoController {
    ...
    //final -- ketika controller membuat obj service, tidak terjadi perulangan (hemat memory)
    ...
    public ResponseEntity<?> createTodo(@Valid @RequestBody Todo todo,
        ...
        Todo createdTodo = todoService.creatOrUpdateTodo(todo);
    ...
    public Todo updateTodo(@PathVariable String id, @RequestBody Todo todo){
        todo.setId(id);
        return todoService.creatOrUpdateTodo(todo);
    }
